...
<aside class="w-60 hidden md:flex flex-col bg-gray-800 border-r border-gray-700 shadow-md fixed h-full">
    ...
    <nav id="sidebarNav" class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
        <a href="${pageContext.request.contextPath}/admin/admin" class="flex items-center p-3 rounded hover:bg-green-600/20 transition">
            <i class="fas fa-users-cog mr-3"></i> Admins
        </a>
        <a href="${pageContext.request.contextPath}/admin/student" class="flex items-center p-3 rounded hover:bg-green-600/20 transition">
            <i class="fas fa-user-graduate mr-3"></i> Students
        </a>
        <a href="${pageContext.request.contextPath}/admin/exam" class="flex items-center p-3 rounded hover:bg-green-600/20 transition">
            <i class="fas fa-file-alt mr-3"></i> Exams
        </a>
        <a href="${pageContext.request.contextPath}/admin/enrollment" class="flex items-center p-3 rounded hover:bg-green-600/20 transition">
            <i class="fas fa-chair mr-3"></i> Enrollments
        </a>
        <a href="${pageContext.request.contextPath}/admin/result" class="flex items-center p-3 rounded hover:bg-green-600/20 transition">
