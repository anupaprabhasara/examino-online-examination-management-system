...
<head>
    ...
    <title>Examino | Student Login</title>
...
<body class="bg-gray-900 text-gray-100 min-h-screen flex items-center justify-center">
    ...
    <div class="bg-gray-800 rounded-2xl shadow-xl p-8 w-full max-w-md space-y-6 border border-gray-700">
        ...
        <div class="text-center">
            ...
            <p class="text-sm text-gray-400 mt-1">Student Login</p>
        </div>
        ...
        <!-- Register Link -->
        <div class="text-center text-sm text-gray-400 pt-3">
            Don’t have an account?
            <a href="${pageContext.request.contextPath}/student/register" class="text-green-400 hover:underline">Register here</a>
        </div>

        <!-- Footer -->
        <div class="text-center text-xs text-gray-500 pt-4 border-t border-gray-700">
            &copy; 2024 Examino Student Portal. All rights reserved.
        </div>
    </div>
