...
<head>
    ...
    <title>Examino | Available Exams</title>
        ...
        <main class="flex-1 p-6 overflow-hidden">
            <div class="bg-gray-800 border border-gray-700 rounded-2xl shadow-xl h-full overflow-hidden flex flex-col">
                <div class="flex justify-between items-center px-6 py-4 border-b border-gray-700">
                    <h3 class="text-lg font-semibold text-green-400"><i class="fas fa-file-alt mr-2"></i>Available Exams</h3>
                </div>
                                ...
                                <tr class="hover:bg-gray-700/40 transition">
                                    ...
                                    <td class="px-6 py-4">
                                        <form action="${pageContext.request.contextPath}/student/exam" method="POST"
                                            ...
                                            <button type="submit"
                                                    class="inline-flex items-center px-3 py-1.5 bg-green-500 hover:bg-green-600 text-white text-xs font-semibold rounded-lg transition">
